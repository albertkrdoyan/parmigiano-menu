...
class _MenuItemCardState extends State<MenuItemCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final subCardWidth =
        width * (widget.isMobile ? 0.68 : 0.78) / c - (c - 1) * 75 / c;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [parmigianoGoldColor, Colors.orange],
          ...
          child: Consumer(
            builder: (context, ref, child) {
              final menuP = ref.watch(menuProvider);
              return Stack(
                      ...
                      children: [
                        ...
                        AnimatedPositioned(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              menuP[widget.subMenu]![widget.index][0],
                              style: TextStyle(
                          ...
                          Positioned(
                            ...
                            child: TweenAnimationBuilder(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  menuP[widget.subMenu]![widget.index][1],
                                  style: TextStyle(
                                    color: Colors.white70,
                                    fontSize: 18,
                                  ),
                        ...
                        AnimatedPositioned(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              '${menuP[widget.subMenu]![widget.index][2]} ֏',
                              style: TextStyle(
                                color: Colors.white70,
                                fontSize: 18,
                              ),
